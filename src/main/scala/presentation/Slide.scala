...
case class Slide1[F[_] : FlatMap](console: Console[F]) extends Slide[F] {
...
case class Slide2[F[_] : FlatMap](console: Console[F]) extends Slide[F] {
  override def show(): F[Unit] =
    console.writeString("""
                          |                               _
                          |     /\                       | |
...
case class Slide3[F[_] : FlatMap](console: Console[F]) extends Slide[F] {
  override def show(): F[Unit] = {
    val stateMachine =
      """
...
case class Slide4[F[_] : FlatMap: Temporal](console: Console[F]) extends Slide[F] {
  override def show(): F[Unit] = {
